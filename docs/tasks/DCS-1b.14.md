...
- [ ] Uwzględnić zmiany w Excelu po dacie zamrożenia (DCS-1b.13; przejęte z DCS-0.1) — zapytać DC, czy coś doszło
...
### Uwaga
Zmiany w Excelu po dacie zamrożenia (DCS-1b.13; przejęte z DCS-0.1) trzeba tu uwzględnić — zapytać DC, czy coś doszło.
...
- 2026-09-23 tj: zależność od DCS-0.1 (dropped) zamieniona na DCS-1b.13.
- 2026-09-23 tj: import SMDR z klientem odłożony — status blocked, termin zdjęty (poprzedni: 2026-09-28); nowy termin przy wznowieniu łańcucha 1a.19 / 1b.12 → 1b.13 → 1b.14 → 1b.15.
