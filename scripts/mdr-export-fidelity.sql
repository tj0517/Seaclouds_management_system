...
-- The fixture project, plus a SECOND one the member has no role on. Without
-- the second, "the export contains what the member may read" is vacuous.
...
begin
  ...
  if n <> 50 then
    raise exception 'fixture seeded % documents, expected 50 — a dictionary code in the insert above does not exist', n;
  end if;
end $$;
