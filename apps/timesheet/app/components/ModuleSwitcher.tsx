...
// (TES here, DCS at MODULE_URLS.dcs) — plain absolute links, not
...
export default function ModuleSwitcher({ hasDcsAccess }: Props) {
  return (
    <div
    ...
    >
      ...
      <span className={`${entryClass} bg-white text-gray-900 shadow-sm`}>TES</span>
      {hasDcsAccess && MODULE_URLS.dcs && (
        <a href={MODULE_URLS.dcs} className={`${entryClass} text-gray-500 hover:bg-white hover:text-gray-900`}>
          DCS
        </a>
      )}
